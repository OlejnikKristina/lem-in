...
// /*   Updated: 2019/08/30 17:56:15 by krioliin      ########   odam.nl         */
// /*                                                                            */
// /* ************************************************************************** */
...
// t_adjvertex	*get_ants_way(t_adjvertex *path, t_vertex *end_vertex)
// {
// 	t_adjvertex *head;
...
// 		if (first_call)
// 		{
// 			head->prev = (t_adjvertex *)malloc(sizeof(t_adjvertex));
// 			head->prev->vertex = end_vertex;
// 			head->next = head;
// 			head->prev->prev = NULL;
// 			first_call = false;
// 		}
...
// 		ant[i]->number = i + 1;
// 		ant[i]->path = get_ants_way(path->path, graph->end_vertex);
// 		ant[i]->arrived = false;
